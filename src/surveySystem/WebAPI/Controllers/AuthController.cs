...
public class AuthController : BaseController
{
    ...
    [HttpPost("Register")]
    public async Task<IActionResult> Register([FromBody] MemberForRegisterDto memberForRegisterDto)
    {
        RegisterCommand registerCommand = new() {MemberForRegisterDto = memberForRegisterDto,IpAddress = getIpAddress() };
