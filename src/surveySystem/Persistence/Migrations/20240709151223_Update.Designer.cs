...
namespace Persistence.Migrations
{
    ...
    [Migration("20240709151223_Update")]
            ...
            modelBuilder.Entity("NArchitecture.Core.Security.Entities.User<int, int>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 204, 26, 165, 111, 168, 7, 127, 151, 240, 43, 127, 19, 144, 120, 84, 51, 139, 59, 25, 31, 153, 83, 62, 98, 228, 248, 212, 133, 193, 143, 13, 23, 191, 240, 207, 227, 236, 8, 53, 136, 171, 193, 87, 231, 128, 154, 152, 154, 178, 77, 137, 15, 249, 193, 21, 74, 21, 211, 126, 228, 242, 68, 240, 148 },
                            PasswordSalt = new byte[] { 206, 105, 78, 58, 50, 70, 183, 228, 236, 220, 254, 158, 254, 229, 134, 180, 179, 87, 233, 144, 78, 50, 101, 23, 13, 126, 137, 160, 165, 149, 179, 234, 161, 158, 218, 229, 73, 189, 206, 198, 245, 208, 194, 20, 66, 134, 74, 75, 62, 239, 120, 237, 120, 55, 182, 59, 172, 75, 118, 65, 91, 231, 131, 92, 65, 55, 142, 91, 65, 222, 68, 24, 149, 72, 99, 197, 45, 220, 122, 48, 13, 207, 149, 100, 128, 231, 196, 225, 223, 144, 161, 54, 201, 59, 72, 56, 188, 117, 102, 126, 215, 184, 173, 65, 139, 228, 146, 200, 77, 84, 23, 220, 81, 91, 47, 30, 119, 32, 204, 106, 171, 210, 187, 68, 140, 74, 165, 126 }
                        });
                });
