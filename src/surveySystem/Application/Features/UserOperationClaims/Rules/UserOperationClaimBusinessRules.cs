...
public class UserOperationClaimBusinessRules : BaseBusinessRules
{
    ...
    public async Task UserOperationClaimShouldExistWhenSelected(UserOperationClaim<int,int,int>? userOperationClaim)
    {
    ...
    public async Task UserOperationClaimShouldNotExistWhenSelected(UserOperationClaim<int, int,int>? userOperationClaim)
    {
        if (userOperationClaim != null)
